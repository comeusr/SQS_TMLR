...
DATASET="--train-dir /home/$USER/DGMS-master/CIFAR100/train/ --val-dir /home/$USER/DGMS-master/CIFAR100/val/ --num-classes 100"
...
python ../main.py $DATASET $MODEL $RESUME $GPU --K ${K} --tau ${TEMP} --dataset ${DATA_NAME} --weight_decay ${WD} --sample \
       ...
       --save_folder /scratch/gilbreth/$USER/DGMS/Run/SAMPLE_${INIT_METHOD}${DATA_NAME}_${MODEL_NAME}/K${K}_temp${TEMP}_LR${LR}_F${FINAL_LR}_WD${WD}
