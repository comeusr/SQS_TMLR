...
DATASET="--train-dir /scratch/gilbreth/$USER/dataset/imagenet/train/ --val-dir /scratch/gilbreth/$USER/dataset/imagenet/val/ --num-classes 1000"
...
python ../main.py $DATASET $MODEL $RESUME $GPU --K ${K} --tau ${TEMP} --dataset ${DATA_NAME} --weight_decay ${WD} --sample \
       ...
       --save_folder /scratch/gilbreth/$USER/DGMS/Run/${INIT_METHOD}${DATA_NAME}_${MODEL_NAME}/K${K}_temp${TEMP}_LR${LR}_prLR${PRUNE_INIT_LR}_F${FINAL_LR}_WD${WD}_2
