...
DATASET="--train-dir /home/$USER/DGMS-master/CIFAR10/train/ --val-dir /home/$USER/DGMS-master/CIFAR10/val/ --num-classes 10"
...
python ../main.py $DATASET $MODEL $RESUME $GPU $FREEZE --K ${K} --tau ${TEMP} --dataset ${DATA_NAME} --weight_decay ${WD} \
       ...
       --run_name K${K}_SPAS${FINAL_SPARSITY}_temp${TEMP}_LR${LR}_F${FINAL_LR}_WD${WD} \
